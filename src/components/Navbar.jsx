  ...
  return (
    <>
      ...
      >
        ...
        <ul
          className={`flex flex-col gap-6 h-screen w-screen fixed z-[100] text-light bg-neutral text-lg header__navigation ${
            isActive ? "is-active" : ""
          }`}
        >
          <li>
        ...
        <button
          className={`header__hamburger sm:hidden ${
            isActive ? "is-active" : ""
          }`}
